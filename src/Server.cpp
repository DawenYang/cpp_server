...
Server::Server(EventLoop *loop) : main_reactor_(loop), acceptor_(nullptr), threadPool_(nullptr) {
    if(main_reactor_ == nullptr) {
        throw Exception(ExceptionType::INVALID, "manin reactor can't be nullptr!");
    }
